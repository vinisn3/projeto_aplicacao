 ...
 * @author user
 */
public class SacadoView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SacadoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
